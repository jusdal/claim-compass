...
def search_policy_documents(
    ...
    Args:
        ...
        location: The location (e.g., "global" or "us").
    ...
    try:
        ...
        request = discoveryengine.SearchRequest(
            ...
            content_search_spec={
                ...
                # "extractive_content_spec" REMOVED to fix 400 Error
            }
        )
        ...
        for i, result in enumerate(response.results, 1):
            ...
            # Get snippets (This now holds the 'Chunks' if chunking is enabled)
            ...
            # Graceful fallback for extractive answers (just in case)
